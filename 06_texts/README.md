...
> [!NOTE] 
> Make sure to check the package name in java file `package com.example.androidtexts;` if you got another name other than `androidtexts` make sure to replace the first line of the code with yours.
