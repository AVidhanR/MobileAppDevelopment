...
> [!NOTE]
> Make sure to check the package name in the java file `package com.example.androidviews;` if you got another name other than `androidviews` make sure to replace the first line of the code with yours.
