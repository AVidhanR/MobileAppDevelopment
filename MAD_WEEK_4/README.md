...
> **Note** :make sure to check the package name in java file `package com.example.linearandrelativelayout;` if you got another name other than `linearandrelativelayout` make sure to replace the first line of the code with yours.
